...
fn print_usage() {
    ...
    eprintln!(
        "  huntctl learn promote-tactic-terminal-for-optimization --bundle EVIDENCE-DIR --output build/DIR [--request OPTIMIZATION.json --execution EXECUTION.json] [--id ID] [--workers N] [--repository-root DIR]"
    );
