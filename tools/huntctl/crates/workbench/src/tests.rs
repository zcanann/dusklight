...
fn graph_exposes_timeline_shape_and_scrub_ranges() {
    ...
    assert_eq!(graph.schema, "dusklight.route-workbench.graph.v19");
...
fn browser_ui_is_a_pannable_segment_graph_with_selection_details() {
    ...
    for required in [
        ...
        "Unique compiled tapes",
        "Successful basin",
        "Action coverage",
        "Temporal coverage",
        "Proposal pressure",
        "CEM concentration",
        "Tick-indexed improvements",
        "Audit evidence",
        "Replay generation",
        "Replay experience",
        "Replay corpus",
...
fn checked_in_ordon_spring_incumbent_composes_its_exact_boot_prefix() {
    ...
    let (segment_id, expected_output) =
        ("to_ordon_spring_q125", "d02b3fd3b7e0f49f600bcf412b34da71");
