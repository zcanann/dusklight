...
fn validate_snapshot(
    ...
    let unique_learning_generations = learning
        ...
        .collect::<BTreeSet<_>>();
    if snapshot.schema != "dusklight.actor-catalog.v4"
    ...
    if learning.source_schema != "dusklight-learning-observation/v8"
        || learning.truncated
...
mod tests {
    ...
    fn fixture_with_learning_generation(
        ...
        let actor_bytes = serde_json::to_vec_pretty(&json!({
            "schema": "dusklight.actor-catalog.v4", "simulation_tick": 29,
            ...
            "learning_actor_population": {
                "source_schema": "dusklight-learning-observation/v8",
