    ...
    let manifest = FactPackManifest::build(
        ...
        vec![
            ...
            FactPackCoverage {
                ...
                scope: "world".into(),
                status: CoverageStatus::Partial,
                detail: "Collision exits retain explicit approach obligations. Exact GZ2E01 L5 boss doors additionally import source-and-placement-bound yaw-oriented checkArea rectangles and positive-local-Z planes; facing and actor-phase execution remain explicit obligations.".into(),
            },
        ],
