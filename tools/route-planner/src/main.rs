    ...
    let manifest = FactPackManifest::build(
        ...
        vec![
            FactPackCoverage {
                ...
                scope: "orig".into(),
                status: CoverageStatus::Partial,
                detail: "Decoded DZS/DZR chunks include STAG, SCLS, MULT, FILI, RTBL, RCAM, and RARO metadata; unresolved chunk semantics and physical reachability remain explicit.".into(),
            },
            FactPackCoverage {
                domain: CoverageDomain::ActorPlacements,
                scope: "orig".into(),
    ...
    let manifest = FactPackManifest::build(
        ...
        vec![
            FactPackCoverage {
                ...
                scope: "world".into(),
                status: CoverageStatus::Partial,
                detail: "All planner-native SCLS, MULT, FILI, RTBL, RCAM, and RARO records are imported; SCLS stays inert unless a source-audited actor transition imports separately.".into(),
            },
            FactPackCoverage {
                domain: CoverageDomain::ActorPlacements,
                scope: "world".into(),
            ...
            FactPackCoverage {
                ...
                scope: "world".into(),
                status: CoverageStatus::Unavailable,
                detail: "The planner-native inventory-set v4 does not decode KCL/PLC, spatial indexes, or collision/SCLS joins.".into(),
            },
            FactPackCoverage {
                domain: CoverageDomain::PhysicalFeasibility,
                scope: "world".into(),
