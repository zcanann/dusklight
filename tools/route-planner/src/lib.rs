...
pub const SOLVE_REPORT_SCHEMA: &str = "dusklight.route-planner.solve-report/v6";
pub const PORTABLE_SOLVE_REPORT_SCHEMA: &str = "dusklight.route-planner.portable-solve-report/v5";
