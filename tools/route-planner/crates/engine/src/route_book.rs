...
pub const ROUTE_BOOK_SCHEMA: &str = "dusklight.route-planner.route-book/v5";
pub const ROUTE_BOOK_EDIT_BATCH_SCHEMA: &str = "dusklight.route-planner.route-book-edit-batch/v5";
