...
pub const REFINEMENT_PACK_SCHEMA: &str = "dusklight.route-planner.refinement-pack/v8";
pub const REFINEMENT_STACK_SCHEMA: &str = "dusklight.route-planner.refinement-stack/v2";
pub const COMPOSED_CATALOG_SCHEMA: &str = "dusklight.route-planner.composed-catalog/v9";
