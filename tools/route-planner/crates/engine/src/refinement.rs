...
pub const REFINEMENT_PACK_SCHEMA: &str = "dusklight.route-planner.refinement-pack/v4";
pub const REFINEMENT_STACK_SCHEMA: &str = "dusklight.route-planner.refinement-stack/v1";
pub const COMPOSED_CATALOG_SCHEMA: &str = "dusklight.route-planner.composed-catalog/v4";
