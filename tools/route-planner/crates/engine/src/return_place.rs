...
use crate::transition::{
    ActivationContract, CandidateTransition, GateRule, MECHANICS_CATALOG_SCHEMA, MechanicsCatalog,
    ReaderRule, StateOperation, TransitionKind, WriterRule,
};
use std::collections::BTreeMap;

pub const GZ2E01_CONTENT_SHA256: Digest = Digest([
    0x6f, 0xc8, 0xc6, 0xf4, 0xc4, 0xdc, 0xd1, 0x67, 0x1c, 0x03, 0x76, 0x46, 0xb2, 0x66, 0x0a, 0xa4,
    0xa0, 0xe5, 0x60, 0x2d, 0x4b, 0xf6, 0x6a, 0xa6, 0xe1, 0x09, 0xab, 0xa5, 0xf2, 0x0a, 0x4a, 0xaa,
]);
pub const GZ2E01_EN_RUNTIME_SHA256: Digest = Digest([
    0x86, 0x2f, 0x97, 0x75, 0x4d, 0x99, 0xc8, 0xfe, 0x8a, 0xbe, 0x9e, 0xbe, 0x5d, 0x94, 0xf5, 0x5a,
    0xad, 0xaa, 0x9d, 0x95, 0x93, 0xf8, 0xec, 0x64, 0x08, 0xde, 0x60, 0x88, 0x0b, 0x75, 0x2a, 0x32,
]);
