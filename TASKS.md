...
| Useful route quality | Not established: the retained human Ordon segment is 125 ticks; the best attributable learned local result is 129 ticks and the from-scratch tactic policy is substantially slower |
...
- [ ] Beat the retained 125-tick human
...
- [ ] Keep q125 as the incumbent unless a strictly faster machine-generated
      descendant passes the same proof contract.
...
4. improves at least one meaningful route-quality benchmark, including a
   cold-proven attempt to beat the retained Ordon q125 segment.
