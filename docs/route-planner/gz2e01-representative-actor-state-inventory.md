...
| `R_Gate` | Switch, layer, pose | Key count, switch domain, and persistent event-bit bypass | Interaction box, pending decrement, paired leaf motion | Event bit may force open independently of the switch; F_SP121 non-memory switches remain unimported |
