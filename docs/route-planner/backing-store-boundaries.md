...
- mechanics catalog to v12, refinement pack to v11, and composed catalog to v12;
- cutscene program/compiled program to v4 and extracted world facts to v4; and
- state inspection to v7, inspection diff to v6, and planner service to v18.
