...
| `jstudio-stb-program/v1` | Exact archive/resource identities; bounded STB/FVB/object/command/paragraph structure; object and function IDs; waits, suspends, jumps, and reserved controls; hashed payloads | Object-specific paragraph/adaptor semantics, gameplay state effects, actor resource requirements, and compiled cutscene transitions |
