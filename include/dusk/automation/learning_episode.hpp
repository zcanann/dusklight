...
inline constexpr std::uint16_t LearningObservationVersion = 9;
inline constexpr std::uint16_t LearningActionVersion = 2;
inline constexpr std::uint32_t LearningEpisodeMaximumTicks = 4096;
inline constexpr std::string_view LearningObservationSchema = "dusklight-learning-observation/v9";
